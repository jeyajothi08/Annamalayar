export const serviceData = {
  ...
  'flatbed-towing': {
    ...
    features: [
      ...
      { title: "Accident Vehicle Transport", desc: "Safe retrieval and loading of vehicles with severe wheel or structural damage." },
      { title: "Automatic & EV Safe Towing", desc: "No wheel-to-ground contact, preventing drivetrain or electric motor strain." },
      { title: "Door-to-Door Delivery", desc: "Convenient pickup from your driveway and precise drop-off at your destination." },
      { title: "Hydraulic Flatbed Tray", desc: "Smooth hydraulic tilting mechanism for low-clearance vehicles." },
      { title: "Damage-Free Loading", desc: "No hooks or metal chains attached to suspension; we secure by the rubber tyres." },
      { title: "GPS Tracking Enabled", desc: "Real-time updates so you can monitor your vehicle's journey continuously." }
    ],
    gallery: [
      { src: "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?auto=format&fit=crop&q=80&w=600", title: "Luxury SUV Transport" },
      { src: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80&w=600", title: "Premium Sedan Secure Loading" },
      { src: "https://images.unsplash.com/photo-1563720223185-11003d516935?auto=format&fit=crop&q=80&w=600", title: "Electric Vehicle Flatbed Loading" },
      { src: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&q=80&w=600", title: "Sports Car Safe Transit" },
      { src: "https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?auto=format&fit=crop&q=80&w=600", title: "Flatbed Truck Ready for Dispatch" }
    ],
    benefits: [
      { title: "Zero Wheel Damage", desc: "Tires are locked in place with soft-strap tie-downs, preventing contact with wheels." },
      { title: "Professional Operators", desc: "Our drivers are extensively certified in loading premium and low-clearance vehicles." },
      { title: "Fast Response Time", desc: "Average response of under 30 minutes in Madurai urban limits." },
      { title: "Safe Transport Guarantee", desc: "No wear on transmission, wheel alignment, or suspension systems." },
      { title: "Insurance Friendly", desc: "Full transit insurance coverage with detailed digital vehicle checklist pre-loading." }
    ],
    process: [
      { step: "01", title: "Service Booking", desc: "Call or fill out our online request form specifying vehicle model, condition, and location." },
      { step: "02", title: "Operator Dispatch", desc: "Our GPS-enabled flatbed truck is immediately dispatched to your location." },
      { step: "03", title: "Safe Loading Sequence", desc: "The flatbed tray is hydraulically lowered and the vehicle is carefully loaded using soft tire-harnesses." },
      { step: "04", title: "Secure Transit", desc: "We transport your vehicle safely with live location tracking link provided to you." },
      { step: "05", title: "Verified Offloading", desc: "Precise delivery, offloading, and signature validation at your preferred workshop or home." }
    ],
    faqs: [
      { 
        q: "Why is flatbed towing recommended for automatic cars and EVs?", 
        a: "In automatic and electric vehicles, towing with wheels on the ground can cause the transmission gears or the regenerative electric motors to spin without proper lubrication, leading to severe system damage. Flatbeds ensure the wheels are completely static." 
      },
      { 
        q: "How do you ensure low-clearance bumper lips do not scrape?", 
        a: "We utilize low-angle hydraulic ramps and, if necessary, custom ramp extensions (wooden blocks or race ramps) to reduce the entry slope. This guarantees zero scraping even on high-end supercars." 
      },
      { 
        q: "Are you fully insured if my vehicle sustains damage?", 
        a: "Yes. Annamalaiyar Towing is fully insured. We carry comprehensive on-hook and transit liability insurance, meaning your vehicle is completely covered from the moment we begin loading until it is unloaded." 
      }
    ],
    reviews: [
      { name: "Rajesh Kumar", rating: 5, date: "2026-06-15", vehicle: "Mercedes Benz C-Class", comment: "Excellent service! Towing a luxury sedan in Madurai can be nerve-wracking, but their hydraulic flatbed loader made it look easy. Zero scratches, and the driver was extremely polite and careful.", verified: true },
      { name: "Dr. Ananya Sen", rating: 5, date: "2026-07-02", vehicle: "Hyundai Ioniq 5 (EV)", comment: "Needed to transport my EV to the Chennai service center. They handled the electronic transmission safety perfectly. Provided live tracking throughout the 8-hour drive. Highly recommended!", verified: true },
      { name: "Karthik Raja", rating: 5, date: "2026-05-20", vehicle: "BMW X5", comment: "Prompt arrival at Melamadai. The flatbed looked brand new and the operator used tyre straps instead of chains. Very professional team.", verified: true }
    ]
  },
  'accident-recovery': {
    ...
    features: [
      ...
      { title: "Integrated Crane Lift", desc: "Rigging and crane lifts for vehicles trapped below highway embankments." },
      { title: "Accident Site Cleanup", desc: "Clearing debris and assisting in securing the immediate crash site for safety." },
      { title: "Flood & Mud Extraction", desc: "Specialized recovery for cars submerged in water channels, mud beds, or canal banks." },
      { title: "Ditch & Ravine Recovery", desc: "Safely pulling vehicles back onto the road surface from deep roadside ditches." },
      { title: "Highway Crash Response", desc: "Coordinating with traffic police for quick removal of blockages on national highways." },
      { title: "Emergency Standby", desc: "Ready-to-dispatch recovery vehicles stationed across Madurai highways." }
    ],
    gallery: [
      { src: "https://images.unsplash.com/photo-1606761568499-6d2451b23c66?auto=format&fit=crop&q=80&w=600", title: "Accident Vehicle Extraction" },
      { src: "https://images.unsplash.com/photo-1506015391300-4802dc74de2e?auto=format&fit=crop&q=80&w=600", title: "Heavy Winch Rigging" },
      { src: "https://images.unsplash.com/photo-1542435503-956c469947f6?auto=format&fit=crop&q=80&w=600", title: "Highway Recovery Underway" },
      { src: "https://images.unsplash.com/photo-1617400324478-f75f73943bb0?auto=format&fit=crop&q=80&w=600", title: "Night Salvage Operation" },
      { src: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&q=80&w=600", title: "Accident Tow Away Wrecker" }
    ],
    benefits: [
      { title: "Rapid Rescue Dispatch", desc: "Dedicated emergency line with immediate dispatching sequence." },
      { title: "Advanced Rigging Gear", desc: "Snatch blocks, spreader bars, and nylon slings to distribute pull forces." },
      { title: "Certified Crew", desc: "Operators trained in mechanical extraction physics and hazard prevention." },
      { title: "Fully Insured Liability", desc: "Protects your vehicle from further damage during heavy recovery." },
      { title: "24/7 Availability", desc: "Operational through stormy weather, floods, and late-night emergencies." }
    ],
    process: [
      { step: "01", title: "Emergency Intake", desc: "Our coordinator records location, vehicle condition, and accessibility constraints." },
      { step: "02", title: "Rigging Setup", desc: "Recovery truck arrives; operators configure winches, lines, and stabilization anchors." },
      { step: "03", title: "Controlled Winching", desc: "A slow, balanced pull is executed to extract the vehicle from the ditch or rollover." },
      { step: "04", title: "Flatbed/Wrecker Securement", desc: "The vehicle is loaded onto a flatbed or secured using hydraulic underlifts." },
      { step: "05", title: "Safe Disposal/Delivery", desc: "Transported to a garage, insurance assessment yard, or salvage yard." }
    ],
    faqs: [
      { 
        q: "What details do I need to tell you after a crash?", 
        a: "Please let us know: 1) Are the wheels rolling or locked? 2) Is the vehicle off the road or in a ditch? 3) Is it leaking fluids? This helps us bring the correct recovery rigs." 
      },
      { 
        q: "Can you recover vehicles from water or deep mud?", 
        a: "Yes, our wreckers are equipped with heavy hydraulic winches and extension lines that allow us to pull vehicles out of ponds, muddy fields, and ditches from up to 100 feet away." 
      },
      { 
        q: "Will my vehicle get more damaged during recovery?", 
        a: "Our certified technicians calculate pull vectors and load distribution before starting. We use soft slings and spreader bars to minimize chassis twist and panel damage." 
      }
    ],
    reviews: [
  ...
  'long-distance-towing': {
    ...
    description: "Reliable long-distance vehicle transportation across Tamil Nadu and South India with live tracking. Perfect for relocations, dealership transfers, and workshop drop-offs.",
    detailedDescription: "Driving a broken, newly bought, or classic vehicle across cities or states is rarely practical. Our long-distance towing division offers a secure, long-haul vehicle transport system using heavy-duty flatbed carriers. We regularly transport vehicles from Madurai to Chennai, Bangalore, Coimbatore, Kochi, and other major hubs across South India. With real-time GPS tracking shared directly to your mobile, you can monitor your vehicle as it traverses highways. We maintain rigid schedules, hire double-driver crews for continuous journeys, and provide comprehensive paperwork assistance, ensuring smooth crossing of state checkposts.",
    features: [
      { title: "Statewide & Interstate Transport", desc: "Authorized vehicle transport spanning Tamil Nadu, Karnataka, Kerala, and AP." },
      { title: "Real-Time GPS Tracking", desc: "Live location sharing link via WhatsApp so you know exactly where your car is." },
      { title: "Secure Door Pickup", desc: "Detailed vehicle condition report and photograph checklist before loading." },
      { title: "Guaranteed Door Delivery", desc: "Safe unloading at your doorstep, service center, or storage facility." },
      { title: "Pre-Travel Safety Checks", desc: "Rigorous check of tyres, tie-downs, and truck mechanics before long journeys." },
      { title: "Accurate ETA Updates", desc: "Continuous updates on traffic conditions and expected delivery times." },
      { title: "Transit Insurance Support", desc: "Guidance and coverage options to cover long-distance transport risks." }
    ],
    gallery: [
      { src: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&q=80&w=600", title: "Interstate Tow Carrier" },
      { src: "https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&q=80&w=600", title: "Luxury Car Pre-Travel Load" },
      { src: "https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&q=80&w=600", title: "Multi-Hour Highway Transit" },
      { src: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&q=80&w=600", title: "Premium Sedan Secure Rigging" },
      { src: "https://images.unsplash.com/photo-1511527661048-7fe73d85e9a4?auto=format&fit=crop&q=80&w=600", title: "Happy Client Delivery" }
    ],
    benefits: [
      { title: "Competitive Rates", desc: "Fixed per-kilometer pricing with no hidden highway toll fees." },
      { title: "Secure Transit Rigs", desc: "All flatbeds are heavily maintained to avoid transit breakdown." },
      { title: "Experienced Long-Haul Drivers", desc: "Drivers licensed and seasoned in national highway navigation." },
      { title: "Double Driver Logistics", desc: "Used on journeys above 400km to ensure minimal rest stops and fast ETAs." }
    ],
    process: [
      { step: "01", title: "Quote & Schedule", desc: "Submit origin, destination, and vehicle details to get a customized long-distance flat-rate quote." },
      { step: "02", title: "Documentation", desc: "Prepare copies of RC, insurance, and emission certificates needed for highway transport checkposts." },
      { step: "03", title: "Inspection & Loading", desc: "Our driver conducts a detailed 20-point outer body inspection and securely mounts the vehicle." },
      { step: "04", title: "Highway Transit", desc: "The vehicle is driven to the destination with live tracking active for the client." },
      { step: "05", title: "Destination Handover", desc: "Offloading and post-transit condition verification, matching the initial check-sheet." }
    ],
    faqs: [
      { 
        q: "What documents do I need to supply for interstate towing?", 
        a: "We require a photocopy of: 1) The Registration Certificate (RC), 2) Active Vehicle Insurance Policy, and 3) Owner's ID proof. This ensures compliance at regional checkposts." 
      },
      { 
        q: "Can I pack personal items inside my car during transport?", 
        a: "A few secure items in the boot are acceptable. However, we advise against keeping valuables or heavy luggage inside the vehicle cabin as it is not covered by standard transit insurance." 
      },
      { 
        q: "How long does a tow from Madurai to Bangalore take?", 
        a: "Typically, it takes 9 to 12 hours depending on highway traffic. We use two drivers on this route to ensure the truck travels with minimal stops." 
      }
    ],
    reviews: [
      { name: "Madan Gopal", rating: 5, date: "2026-06-25", vehicle: "Audi A6", comment: "Needed to send my Audi for major repairs from Madurai to Bangalore. Annamalaiyar's long distance towing did a fantastic job. The GPS tracking link was 100% accurate, and the driver kept calling to update me.", verified: true },
